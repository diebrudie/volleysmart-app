      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2 lg:pr-12">
          ...
          <p className="mt-4 text-lg md:text-xl opacity-90">
            Create balanced teams, track match history, and manage your players
            - all in one place.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            {isAuthenticated ? (
              <Link to="/login">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-volleyball-secondary text-volleyball-primary hover:bg-volleyball-secondary/90"
                >
