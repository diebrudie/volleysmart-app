...
const mockTeamData = {
  teamA: [
    { id: '1', name: 'Isabel', preferredPosition: 'Outside Hitter', skillRating: 8 },
    { id: '2', name: 'Eduardo', preferredPosition: 'Setter', skillRating: 7 },
    { id: '3', name: 'Carlotta', preferredPosition: 'Opposite Hitter', skillRating: 6 },
  ...
  teamB: [
    { id: '7', name: 'Ana', preferredPosition: 'Middle Blocker', skillRating: 8 },
    { id: '8', name: 'Maria', preferredPosition: 'Outside Hitter', skillRating: 7 },
    { id: '9', name: 'Pepito', preferredPosition: 'Opposite Hitter', skillRating: 6 },
    { id: '10', name: 'Carlos', preferredPosition: 'Outside Hitter', skillRating: 7 },
    { id: '11', name: 'Maria', preferredPosition: 'Setter', skillRating: 8 },
    { id: '12', name: 'Ana Isabel', preferredPosition: 'Libero', skillRating: 9 }
  ] as EditPlayer[]
};
...
const EditGame = () => {
  ...
  const [teamAPlayers, setTeamAPlayers] = useState<EditPlayer[]>(mockTeamData.teamA);
  const [teamBPlayers, setTeamBPlayers] = useState<EditPlayer[]>(mockTeamData.teamB);
    ...
    if (sourceTeam === targetTeam) {
      ...
      if (sourceTeam === 'A') {
        setTeamAPlayers(currentPlayers => {
          const oldIndex = currentPlayers.findIndex(p => String(p.id) === sourceId);
          const newIndex = currentPlayers.findIndex(p => String(p.id) === targetId);
      ...
      if (sourceTeam === 'A') {
        ...
        if (playerToMove) {
          ...
          setTeamBPlayers(currentPlayers => {
            const targetIndex = currentPlayers.findIndex(p => String(p.id) === targetId);
  ...
  const PlayerRow = ({ player, teamColor, teamId }: { 
    player: EditPlayer; 
    teamColor: string; 
    teamId: string;
  }) => {
          ...
          <div className="flex-grow">
            ...
            {isEditing ? (
              <Select
                ...
                onValueChange={(value) => handlePositionChange(player.id, value)}
              >
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-6">Edit Teams</h1>
